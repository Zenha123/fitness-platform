...
export default function BookingSuccessPage() {
  ...
  return (
    <div className="min-h-screen bg-[var(--color-bg)] text-white">
      ...
      <PageContainer variant="narrow" className="px-4 py-8 sm:px-6 sm:py-12">
        <div className="space-y-6 rounded-[var(--radius-2xl)] border border-white/10 bg-[var(--color-ink)] p-5 text-center shadow-2xl sm:space-y-8 sm:p-8 md:p-12">
          ...
          {intakeToken && (
            <div className="space-y-4 rounded-xl border border-blue-500/40 bg-blue-500/15 p-4 sm:p-6">
              <h3 className="text-base font-bold text-blue-400 sm:text-lg">Next step: complete intake</h3>
